// antha-tools/go/ssa/interp/interp_test.go: Part of the Antha language
...
func run(t *testing.T, dir, input string, success successPredicate) bool {
	...
	hint = fmt.Sprintf("To dump SSA representation, run:\n%% antha build antha-tools/cmd/ssadump && ./ssadump -build=CFP %s\n", input)
	...
	hint = fmt.Sprintf("To trace execution, run:\n%% antha build antha-tools/cmd/ssadump && ./ssadump -build=C -run --interp=T %s\n", input)
