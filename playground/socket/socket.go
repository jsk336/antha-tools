// antha-tools/playground/socket/socket.go: Part of the Antha language
...
// Environ provides an environment when a binary, such as the antha tool, is
// invoked.
...
func (p *process) start(body string, opt *Options) error {
	...
	// (rather than the antha tool process).
