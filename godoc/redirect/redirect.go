// antha-tools/godoc/redirect/redirect.go: Part of the Antha language
...
var redirects = map[string]string{
	...
	"/cmd/godoc/": "http://godoc.org/antha-tools/cmd/godoc/",
	"/cmd/vet/":   "http://godoc.org/antha-tools/cmd/vet/",
