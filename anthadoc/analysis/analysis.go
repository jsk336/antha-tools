// antha-tools/anthadoc/analysis/analysis.go: Part of the Antha language
...
//
// ERRORS: for each locus of a static (antha/types) error, the location
...
// Derived from from antha/ssa/stdlib_test.go
