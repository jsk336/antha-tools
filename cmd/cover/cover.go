// antha-tools/cmd/cover/cover.go: Part of the Antha language
...
// antha/printer to print a modified AST containing comments.
//
func initialComments(content []byte) []byte {
	// Derived from antha/build.Context.shouldBuild.
	end := 0
	p := content
	for len(p) > 0 {
		line := p
