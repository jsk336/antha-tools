// antha-tools/cmd/oracle/main.go: Part of the Antha language
...
import (
	...
	"github.com/antha-lang/antha-tools/oracle"
)
...
% oracle -pos=src/antha-tools/cmd/oracle/main.go:#530 describe \
   antha-tools/cmd/oracle
