// antha-tools/cmd/godex/writetype.go: Part of the Antha language
...
// directly from antha/types, but now contains various modifications for
// nicer output.
//
// TODO(gri) back-port once we have a fixed interface and once the
// antha/types API is not frozen anymore for the 1.3 release; and remove
...
// From antha/types - leave for now to ease back-porting this code.
