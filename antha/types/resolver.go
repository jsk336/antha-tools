// antha-tools/antha/types/resolver.go: Part of the Antha language
...
func (check *checker) collectObjects() {
	...
	if importer == nil {
		if DefaultImport == nil {
			panic(`no Config.Import or DefaultImport (missing import _ "github.com/antha-lang/antha-tools/antha/gcimporter"?)`)
		}
