// antha-tools/antha/loader/loader.go: Part of the Antha language
...
// same directory.  (antha/build.Package calls these files XTestFiles.)
//
...
// (antha/build.Package calls these files TestFiles.)
//
...
func (conf *Config) parsePackageFiles(path string, which rune) ([]*ast.File, error) {
	// Set the "!cgo" antha/build tag, preferring (dummy) Go to
...
// (e.g. antha/build or parse error), but type errors are reported via
