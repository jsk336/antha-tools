// antha-tools/antha/gcimporter/gcimporter.go: Part of the Antha language
...
// Importing this package installs Import as antha/types.DefaultImport.
package gcimporter
...
func FindPkg(path, srcDir string) (filename, id string) {
	...
	case filepath.IsAbs(path):
		// for completeness only - antha/build.Import
