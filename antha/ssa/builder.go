// antha-tools/antha/ssa/builder.go: Part of the Antha language
...
// by antha/types.Info.InitOrder, then code for each function in the
...
func (p *Package) Build() {
	...
	p.info = nil // We no longer need ASTs or antha/types deductions.
}
