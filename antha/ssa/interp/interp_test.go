// antha-tools/antha/ssa/interp/interp_test.go: Part of the Antha language
...
// These are files in go.tools/antha/ssa/interp/testdata/.
...
func run(t *testing.T, dir, input string, success successPredicate) bool {
	...
	hint = fmt.Sprintf("To dump SSA representation, run:\n%% antha build code.google.com/p/go.tools/cmd/ssadump && ./ssadump -build=CFP %s\n", input)
	...
	hint = fmt.Sprintf("To trace execution, run:\n%% antha build code.google.com/p/go.tools/cmd/ssadump && ./ssadump -build=C -run --interp=T %s\n", input)
