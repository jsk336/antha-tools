// antha-tools/oracle/oracle.go: Part of the Antha language
...
// command-line is provided by antha-tools/cmd/oracle.
//
...
// buildContext is the antha/build configuration for locating packages.
...
// "what" query, which needs to access the antha/build.Context.
//
