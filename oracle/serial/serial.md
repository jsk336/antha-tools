...
Callees is nonempty unless the call was a dynamic call on a provably nil func or
interface value.
...
A DescribeValue is the additional result of a 'describe' query if the selection
