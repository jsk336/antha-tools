// antha-tools/dashboard/builder/env.go: Part of the Antha language
...
import (
	...
	"github.com/antha-lang/antha-tools/antha/vcs"
)
...
// setup for a goEnv clones the main antha repo to workpath/go at the provided hash
// and returns the path workpath/go/src, the location of all antha build scripts.
